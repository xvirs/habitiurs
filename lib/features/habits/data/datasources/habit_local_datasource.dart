...
class HabitLocalDataSourceImpl implements HabitLocalDataSource {
  ...
  Future<List<HabitModel>> getAllHabits({bool includeInactive = false}) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al obtener todos los hábitos: $e\n$stackTrace');
  ...
  Future<int> insertHabit(HabitModel habit) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al insertar hábito: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<void> insertHabitWithId(HabitModel habit) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al insertar hábito con ID: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<void> updateHabit(HabitModel habit) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al actualizar hábito: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<void> deleteHabit(int id) async {
    ...
    try { 
      ...
      await db.transaction((txn) async {
        ...
        print('DEBUG: Eliminadas entradas para hábito $id de la DB local.');
        ...
        print('DEBUG: Hábito $id eliminado físicamente de la DB local.');
      });
    } catch (e, stackTrace) {
      // Se captura cualquier excepción durante la transacción y se relanza
      print('❌ [HabitLocalDataSource] CRITICAL ERROR al eliminar hábito $id: $e\n$stackTrace');
  ...
  Future<List<HabitEntryModel>> getHabitEntriesForDateRange(
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al obtener entradas para rango de fecha: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<HabitEntryModel?> getHabitEntryForDate(
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al obtener entrada para fecha: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<int> insertHabitEntry(HabitEntryModel entry) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al insertar entrada de hábito: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<void> updateHabitEntry(HabitEntryModel entry) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al actualizar entrada de hábito: $e\n$stackTrace');
      rethrow;
    }
  }
  ...
  Future<void> deleteHabitEntry(int habitId, DateTime date) async {
    ...
    try {
      ...
      print('❌ [HabitLocalDataSource] Error al eliminar entrada de hábito: $e\n$stackTrace');
      rethrow;
    }
  }
}
